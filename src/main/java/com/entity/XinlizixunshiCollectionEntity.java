...
public class XinlizixunshiCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public XinlizixunshiCollectionEntity() {

	}

	public XinlizixunshiCollectionEntity(T t) {
		try {
     ...
     * 类型
     */
    @TableField(value = "xinlizixunshi_collection_types")
    ...
    public String toString() {
        return "XinlizixunshiCollection{" +
            "id=" + id +
            ", xinlizixunshiId=" + xinlizixunshiId +
            ", yonghuId=" + yonghuId +
            ", xinlizixunshiCollectionTypes=" + xinlizixunshiCollectionTypes +
