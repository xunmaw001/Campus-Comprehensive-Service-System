...
public class XunwuLiuyanView extends XunwuLiuyanEntity implements Serializable {
	...
	public XunwuLiuyanView() {

	}

	public XunwuLiuyanView(XunwuLiuyanEntity xunwuLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, xunwuLiuyanEntity);
