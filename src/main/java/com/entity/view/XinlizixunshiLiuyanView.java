...
public class XinlizixunshiLiuyanView extends XinlizixunshiLiuyanEntity implements Serializable {
	...
	public XinlizixunshiLiuyanView() {

	}

	public XinlizixunshiLiuyanView(XinlizixunshiLiuyanEntity xinlizixunshiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, xinlizixunshiLiuyanEntity);
