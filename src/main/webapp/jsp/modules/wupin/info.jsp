            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">二手市场登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="yonghuId" name="yonghuId" v-model="ruleForm.yonghuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="wupinName" name="wupinName" class="form-control"
                                               v-model="ruleForm.wupinName" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>物品照片</label>
                                    <img id="wupinPhotoImg" width="100" height="100">
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>交易地点</label>
                                        <input style="width: 450px" id="wupinAddress" name="wupinAddress" class="form-control"
                                               v-model="ruleForm.wupinAddress" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="lianxirenName" name="lianxirenName" class="form-control"
                                               v-model="ruleForm.lianxirenName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="lianxirenPhone" name="lianxirenPhone" class="form-control"
                                               v-model="ruleForm.lianxirenPhone" readonly>
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input style="width: 450px" id="wupinValue" name="wupinValue" class="form-control"
                                           v-model="ruleForm.wupinValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>物品数量</label>
                                        <input style="width: 450px" id="wupinNumber" name="wupinNumber" class="form-control"
                                               v-model="ruleForm.wupinNumber" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>物品状态</label>
                                    <input style="width: 450px" id="wupinMaichuValue" name="wupinMaichuValue" class="form-control"
                                           v-model="ruleForm.wupinMaichuValue" readonly>
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>物品购买价格</label>
                                        <input style="width: 450px" id="wupinOldMoney" name="wupinOldMoney" class="form-control"
                                               v-model="ruleForm.wupinOldMoney" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="wupinNewMoney" name="wupinNewMoney" class="form-control"
                                               v-model="ruleForm.wupinNewMoney" readonly>
                                    </div>
...
<script>
    ...
    function setContent() {
        ...
        if (ruleForm.wupinContent != null && ruleForm.wupinContent != 'null' && ruleForm.wupinContent != '') {
            var wupinContentUeditor = UE.getEditor('wupinContentEditor');
                wupinContentUeditor.ready(function () {
                    ...
                    wupinContentUeditor.setDisabled('fullscreen');
            });
        }
    }
