...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">二手市场管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">二手市场管理</li>
                            <li class="breadcrumb-item active">二手市场列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">二手市场列表</h3>
                            <div class="table-responsive mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        物品状态
                                        <div class="layui-input-inline">
                                            <select name="wupinMaichuTypesSelectSearch"  style="width: 150px;" id="wupinMaichuTypesSelectSearch" class="form-control form-control-sm"
                                                    aria-controls="tableId">
                                            </select>
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            if(wupinTypesSelectSearchInput != null){
                ...
                //物品状态
            var wupinMaichuTypesSelectSearchInput = document.getElementById("wupinMaichuTypesSelectSearch");
            if(wupinMaichuTypesSelectSearchInput != null){
                var wupinMaichuTypesIndex = wupinMaichuTypesSelectSearchInput.selectedIndex;
                if( wupinMaichuTypesIndex  != 0){
                    searchForm.wupinMaichuTypes= document.getElementById("wupinMaichuTypesSelectSearch").options[wupinMaichuTypesIndex].value;
                }
            }
                                    getDataList();
        }
        ...
        function getDataList() {
            http("wupin/page", "GET", {
                ...
                wupinMaichuTypes: searchForm.wupinMaichuTypes,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //交易地点
            var wupinAddressCell = document.createElement('td');
            wupinAddressCell.innerHTML = item.wupinAddress;
            row.appendChild(wupinAddressCell);
            ...
            //物品数量
            var wupinNumberCell = document.createElement('td');
            wupinNumberCell.innerHTML = item.wupinNumber;
            row.appendChild(wupinNumberCell);


            //物品状态
            var wupinMaichuTypesCell = document.createElement('td');
            wupinMaichuTypesCell.innerHTML = item.wupinMaichuValue;
            row.appendChild(wupinMaichuTypesCell);


            //物品购买价格
            var wupinOldMoneyCell = document.createElement('td');
            wupinOldMoneyCell.innerHTML = item.wupinOldMoney;
            row.appendChild(wupinOldMoneyCell);


            //出售价格
            var wupinNewMoneyCell = document.createElement('td');
            wupinNewMoneyCell.innerHTML = item.wupinNewMoney;
            row.appendChild(wupinNewMoneyCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("wupin/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addwupin", "addwupin");
            window.location.href = "add-or-update.jsp"
        }
    ...
    //填充本表搜索下拉框
        ...
        function wupinMaichuTypesSelectSearch() {
            var wupinMaichuTypesSelectSearch = document.getElementById('wupinMaichuTypesSelectSearch');
            if(wupinMaichuTypesSelectSearch != null) {
                wupinMaichuTypesSelectSearch.add(new Option('-请选择-',''));
                if (wupinMaichuTypesOptions != null && wupinMaichuTypesOptions.length > 0){
                    for (var i = 0; i < wupinMaichuTypesOptions.length; i++) {
                            wupinMaichuTypesSelectSearch.add(new Option(wupinMaichuTypesOptions[i].indexName,wupinMaichuTypesOptions[i].codeIndex));
                    }
                }
            }
        }
    ...
    //查询当前表搜索条件所有列表
            ...
            function wupinMaichuTypesSelect() {
                //填充下拉框选项
                http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=wupin_maichu_types", "GET", {}, (res) => {
                    if(res.code == 0){
                        wupinMaichuTypesOptions = res.data.list;
                    }
                });
            }
