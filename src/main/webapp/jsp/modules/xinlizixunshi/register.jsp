...
<body style="background-image:url('/xiaoyuanzonghefuwu/img/back-img-bg.jpg') !important;background-size:cover;">
<!-- Pre Loader -->
<div class="loading">
    <div class="spinner">
                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="register">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    <label>咨询师姓名</label>
                                    <input id="xinlizixunshiName" name="xinlizixunshiName" class="form-control"
                                           placeholder="咨询师姓名">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>咨询师手机号</label>
                                    <input id="xinlizixunshiPhone" name="xinlizixunshiPhone" class="form-control"
                                           onchange="xinlizixunshiPhoneChickValue(this)"  placeholder="咨询师手机号">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>擅长</label>
                                    <input id="xinlizixunshiShanchang" name="xinlizixunshiShanchang" class="form-control"
                                           placeholder="擅长">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>电子邮箱</label>
                                    <input id="xinlizixunshiEmail" name="xinlizixunshiEmail" class="form-control"
                                           placeholder="电子邮箱">
                                </div>
                                   <div class="form-group col-md-12">
                                       <label>性别</label>
    ...
    <script>
        ...
        function submit() {
            ...
            if (validform() == true && compare() == true) {
                ...
                var urlParam;
                var successMes = '';
                httpJson("xinlizixunshi/register", "POST", data, (res) => {
                    if(res.code == 0){
        ...
        function getContent() {
            ...
            if (xinlizixunshiContentEditor.hasContents()) {
                $('#xinlizixunshiContent-input').attr('value', xinlizixunshiContentEditor.getPlainTxt());
            }
        }
