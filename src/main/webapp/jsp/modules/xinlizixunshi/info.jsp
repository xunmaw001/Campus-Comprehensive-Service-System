            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">心里咨询师登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="xinlizixunshiPhone" name="xinlizixunshiPhone" class="form-control"
                                               v-model="ruleForm.xinlizixunshiPhone" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>咨询师照片</label>
                                    <img id="xinlizixunshiPhotoImg" width="100" height="100">
                                </div>

                                    <div class="form-group col-md-6">
                                        <label>擅长</label>
                                        <input style="width: 450px" id="xinlizixunshiShanchang" name="xinlizixunshiShanchang" class="form-control"
                                               v-model="ruleForm.xinlizixunshiShanchang" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input style="width: 450px" id="xinlizixunshiEmail" name="xinlizixunshiEmail" class="form-control"
                                               v-model="ruleForm.xinlizixunshiEmail" readonly>
                                    </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "xinlizixunshi/info/" + id,
