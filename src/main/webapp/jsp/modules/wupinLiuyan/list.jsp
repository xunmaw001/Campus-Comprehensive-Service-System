...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">二手市场留言管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">二手市场留言管理</li>
                            <li class="breadcrumb-item active">二手市场留言列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">二手市场留言列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            //留言内容
            var wupinLiuyanTextCell = document.createElement('td');
            wupinLiuyanTextCell.innerHTML = item.wupinLiuyanText;
            row.appendChild(wupinLiuyanTextCell);
            ...
            if(
                ...
                (window.sessionStorage.getItem('role') == "用户" && window.sessionStorage.getItem('userId') == item.wupinYonghuId)
            ){
                //修改按钮
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("wupinLiuyan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addwupinLiuyan", "addwupinLiuyan");
            window.location.href = "add-or-update.jsp"
        }
