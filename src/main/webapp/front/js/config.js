...
var centerMenu = [
    ...
    ,{
        name: '活动收藏',
        url: '../huodongCollection/list.jsp'
    }
    ,{
        name: '活动报名',
        url: '../huodongOrder/list.jsp'
    }
    ,{
        name: '二手市场收藏',
        url: '../wupinCollection/list.jsp'
    }
    ,{
        name: '心里咨询师收藏',
        url: '../xinlizixunshiCollection/list.jsp'
    }
    ,{
        name: '寻物收藏',
        url: '../xunwuCollection/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '活动',
        url: './pages/huodong/list.jsp'
    },
    {
        name: '二手市场',
        url: './pages/wupin/list.jsp'
    },
    {
        name: '心里咨询师',
        url: './pages/xinlizixunshi/list.jsp'
    },
    {
        name: '寻物',
        url: './pages/xunwu/list.jsp'
    },

]

var adminurl =  "http://localhost:8080/xiaoyuanzonghefuwu/jsp/login.jsp";
