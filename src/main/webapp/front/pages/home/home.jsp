            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            ...
                            <span class="ng-inmod-the-cn" aos="fade-down">二手市场展示</span>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-prslist ng-fault ng-container">
                        <ul>
                            <li v-for="(item,index) in wupinList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jumpCheck('../wupin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" >
                                        <a href="#" class="ng-prsliik">
                                            <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                                <img class="swiper-item" :src="item.wupinPhoto?item.wupinPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                            </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jumpCheck('../wupin/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" ><span>{{item.wupinName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.wupinNewMoney"><span style="color: red;">{{item.wupinNewMoney}} RMB</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right"><img src="../../xznstatic/img/insie1.png" alt="" /></span>
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-right" aos="fade-up-left"><img src="../../xznstatic/img/insie2.png" alt="" /></span>
                            <span class="ng-inmod-the-cn" aos="fade-down">活动展示</span>
                            <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                        </div>
                        <span class="ng-inmod-thebor" aos="fade-up"></span>
                    </div>
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-prslist ng-fault ng-container">
                        <ul>
                            <li v-for="(item,index) in huodongList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jumpCheck('../huodong/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" >
                                        <a href="#" class="ng-prsliik">
                                            <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                                <img class="swiper-item" :src="item.huodongPhoto?item.huodongPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                            </span>
                                            <span class="ng-prsliik-ki ng-prsliik-ki_2">
                                                <img class="swiper-item" :src="item.huodongPhoto?item.huodongPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                            </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jumpCheck('../huodong/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" ><span>{{item.huodongName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.huodongNewMoney"><span style="color: red;">{{item.huodongNewMoney}} RMB</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="ng-inmod-ini">
                    <div class="ng-fault ng-container">
                        <div class="ng-inmod-the ng-container">
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right"><img src="../../xznstatic/img/insie1.png" alt="" /></span>
                            <span class="ng-inmod-the-bg ng-inmod-the-bg-right" aos="fade-up-left"><img src="../../xznstatic/img/insie2.png" alt="" /></span>
                            <span class="ng-inmod-the-cn" aos="fade-down">寻物展示</span>
                            <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                        </div>
                        <span class="ng-inmod-thebor" aos="fade-up"></span>
                    </div>
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-prslist ng-fault ng-container">
                        <ul>
                            <li v-for="(item,index) in xunwuList" v-bind:key="index">
                                <div class="ng-prslist-doc">
                                    <div class="ng-prslist-img" @click="jumpCheck('../xunwu/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" >
                                        <a href="#" class="ng-prsliik">
                                            <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                                <img class="swiper-item" :src="item.xunwuPhoto?item.xunwuPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                            </span>
                                            <span class="ng-prsliik-ki ng-prsliik-ki_2">
                                                <img class="swiper-item" :src="item.xunwuPhoto?item.xunwuPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                            </span>
                                    ...
                                    <div class="ng-prslist-tit" @click="jumpCheck('../xunwu/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)" ><span>{{item.xunwuName}}</span></div>
                                    <div class="ng-prslist-tit" v-if="item.xunwuNewMoney"><span style="color: red;">{{item.xunwuNewMoney}} RMB</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`huodong/list`, 'get', {
            ...
            vue.huodongList = res.data.list;
        });
        http.request(`xunwu/list`, 'get', {
            page: 1,
            limit: 8,
            xunwuDelete: 1,
        }, function (res) {
            vue.xunwuList = res.data.list;
        });
    });
</script>
