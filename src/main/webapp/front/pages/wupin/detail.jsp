        ...
        <div class="data-detail">
            ...
            <div class="layui-row">
                ...
                <div class="layui-col-md7" style="padding-left: 20px;">
                        ...
                        <div v-if="detail.wupinAddress" class="detail-item">
                            <span>交易地点：</span>
                            <span class="desc">
                                        {{detail.wupinAddress}}
                            </span>
                        ...
                        <div v-if="detail.wupinNumber" class="detail-item">
                            <span>物品数量：</span>
                            <span class="desc">
                                {{detail.wupinNumber}}
                            </span>
                        ...
                        <div v-if="detail.wupinMaichuTypes" class="detail-item">
                            <span>物品状态：</span>
                            <span class="desc">
                                {{detail.wupinMaichuValue}}
                            </span>
                        </div>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage', 'rate'], function () {
        ...
        http.request(`wupin/list`, 'get', {
            ...
            wupinDelete: 1,
                ...
                wupinMaichuTypes: vue.detail.wupinMaichuTypes,
