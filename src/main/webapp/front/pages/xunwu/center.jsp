    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xunwuName" id="xunwuName" lay-verify="required" placeholder="寻物名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="xunwuPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="xunwuPhoto" name="xunwuPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="lianxirenPhone" id="lianxirenPhone"  lay-verify="required|phone"   placeholder="联系人手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="xunwuTypes" id="xunwuTypes">
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="xunwuZhuangtaiTypes" id="xunwuZhuangtaiTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="diushiTime" id="diushiTime"  lay-verify="required|date"   placeholder="丢失时间" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="diushiAddress" id="diushiAddress" lay-verify="required" placeholder="丢失地点" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="diushiTezheng" id="diushiTezheng" lay-verify="required" placeholder="特征" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`xunwu/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#xunwuPhotoImg").attr("src", data.data.xunwuPhoto);
                });
