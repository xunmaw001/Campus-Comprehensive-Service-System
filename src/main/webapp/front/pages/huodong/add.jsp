...
<!-- 唯一uuid -->
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-inline">
                    <input  type="text" name="huodongUuidNumber" id="huodongUuidNumber"  lay-verify="required"   placeholder="活动编号" autocomplete="off" class="layui-input" readonly="readonly">
                </div>
            </div>
            <div class="layui-form-item" pane>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input <%--v-model="detail.kaishiTime"--%> type="text" name="kaishiTime" id="kaishiTime" placeholder="活动开始日期" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            ...
            <div class="layui-form-item" pane>
                ...
                <div class="layui-input-block">
                    <input <%--v-model="detail.jieshuTime"--%> type="text" name="jieshuTime" id="jieshuTime" placeholder="活动结束日期" lay-verify="required" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
