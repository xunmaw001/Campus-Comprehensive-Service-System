            ...
            <article>
              <form class="layui-form login-form" lay-filter="register">
                ...
                <div class="layui-form-item layui-form-text input">
                  ...
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">咨询师姓名:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="xinlizixunshiName" id="xinlizixunshiName"  placeholder="咨询师姓名"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 手机号 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">咨询师手机号:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="xinlizixunshiPhone" id="xinlizixunshiPhone"  lay-verify="phone|required"   placeholder="咨询师手机号" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                  <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">擅长:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="xinlizixunshiShanchang" id="xinlizixunshiShanchang"  placeholder="擅长"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
<!-- 邮箱 -->
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="xinlizixunshiEmail" id="xinlizixunshiEmail"  lay-verify="email|required"   placeholder="电子邮箱" autocomplete="off" class="layui-input" style="width: 400px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
