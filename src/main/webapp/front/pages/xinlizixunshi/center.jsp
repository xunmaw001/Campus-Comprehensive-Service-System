    ...
    <ul id="category">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xinlizixunshiName" id="xinlizixunshiName" lay-verify="required" placeholder="咨询师姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xinlizixunshiPhone" id="xinlizixunshiPhone"  lay-verify="required|phone"   placeholder="咨询师手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="xinlizixunshiPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="xinlizixunshiPhoto" name="xinlizixunshiPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xinlizixunshiShanchang" id="xinlizixunshiShanchang" lay-verify="required" placeholder="擅长" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="xinlizixunshiEmail" id="xinlizixunshiEmail"  lay-verify="required|email"   placeholder="电子邮箱" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`xinlizixunshi/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#xinlizixunshiPhotoImg").attr("src", data.data.xinlizixunshiPhoto);
                });
